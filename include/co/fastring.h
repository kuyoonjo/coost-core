...
inline co::fastring operator+(const co::fastring &a, char b) {
  co::fastring s(a.size() + 2);
  s.append(a).append(b);
  return s;
}

inline co::fastring operator+(char a, const co::fastring &b) {
  co::fastring s(b.size() + 2);
  s.append(a).append(b);
  return s;
}

inline co::fastring operator+(const co::fastring &a, const co::fastring &b) {
  co::fastring s(a.size() + b.size() + 1);
  s.append(a).append(b);
  return s;
}

inline co::fastring operator+(const co::fastring &a, const std::string &b) {
  co::fastring s(a.size() + b.size() + 1);
  s.append(a).append(b);
  return s;
}

inline co::fastring operator+(const std::string &a, const co::fastring &b) {
  co::fastring s(a.size() + b.size() + 1);
  s.append(a).append(b);
  return s;
}

inline co::fastring operator+(const co::fastring &a, const char *b) {
  const size_t n = strlen(b);
  co::fastring s(a.size() + n + 1);
  s.append(a).append(b, n);
  return s;
}

inline co::fastring operator+(const char *a, const co::fastring &b) {
  const size_t n = strlen(a);
  co::fastring s(b.size() + n + 1);
  s.append(a, n).append(b);
  return s;
}

inline bool operator==(const co::fastring &a, const co::fastring &b) {
  return a.size() == b.size() &&
         (a.empty() || memcmp(a.data(), b.data(), a.size()) == 0);
}

inline bool operator==(const co::fastring &a, const std::string &b) {
  return a.size() == b.size() &&
         (a.empty() || memcmp(a.data(), b.data(), a.size()) == 0);
}

inline bool operator==(const std::string &a, const co::fastring &b) {
  return b == a;
}

inline bool operator==(const co::fastring &a, const char *b) {
  return a.size() == strlen(b) &&
         (a.empty() || memcmp(a.data(), b, a.size()) == 0);
}

inline bool operator==(const char *a, const co::fastring &b) { return b == a; }
...
inline bool operator<=(const char *a, const co::fastring &b) {
  return !(b < a);
}
...
inline std::ostream &operator<<(std::ostream &os, const co::fastring &s) {
  return os.write(s.data(), s.size());
}

namespace std {
template <> struct hash<co::fastring> {
  size_t operator()(const co::fastring &s) const {
...
public:
  ...
  anystr(const co::fastring &s) noexcept : _s(s.data()), _n(s.size()) {}
