...
inline co::vector<fastring> split(const fastring &s, const char *c,
                                  uint32 n = 0) {
 ...
 */
__coapi fastring replace(const char *s, const char *sub, const char *to,
                         uint32 n = 0);
__coapi fastring replace(const fastring &s, const char *sub, const char *to,
                         uint32 n = 0);
 ...
 *   - Call co::error() to get the error number. DO NOT use `errno` directly as
...
template <typename T> inline fastring dbg(const co::vector<T> &v) {
  return xx::dbg(v.begin(), v.end(), '[', ']');
}
...
template <typename T> inline fastring dbg(const co::set<T> &v) {
  return xx::dbg(v.begin(), v.end(), '{', '}');
}
...
template <typename K, typename V> inline fastring dbg(const co::map<K, V> &v) {
  return xx::dbg(v.begin(), v.end(), '{', '}');
}
...
template <typename T> inline fastring dbg(const co::hash_set<T> &v) {
  return xx::dbg(v.begin(), v.end(), '{', '}');
}
