...
public:
  ...
  fastream &append(uint16 v) { return this->append(&v, sizeof(v)); }

  fastream &append(uint32 v) { return this->append(&v, sizeof(v)); }

  fastream &append(uint64 v) { return this->append(&v, sizeof(v)); }
