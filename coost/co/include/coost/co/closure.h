...
template <typename F> class Function0 : public Closure {
public:
...
template <typename F> class Function0p : public Closure {
public:
  Function0p(F *f) : _f(f) {}
...
template <typename F, typename P> class Function1 : public Closure {
public:
...
template <typename F, typename P> class Function1p : public Closure {
public:
...
template <typename T> class Method0 : public Closure {
public:
  typedef void (T::*F)();
...
template <typename F, typename T, typename P> class Method1 : public Closure {
public:
  Method1(F &&f, T *o, P &&p)
 ...
 */
template <typename F> inline Closure *new_closure(F &&f) {
  return mem::make<xx::Function0<F>>(std::forward<F>(f));
}
 ...
 */
template <typename F> inline Closure *new_closure(F *f) {
  return mem::make<xx::Function0p<F>>(f);
}
 ...
 */
template <typename F, typename P> inline Closure *new_closure(F &&f, P &&p) {
  return mem::make<xx::Function1<F, P>>(std::forward<F>(f), std::forward<P>(p));
}
 ...
 */
template <typename F, typename P> inline Closure *new_closure(F *f, P &&p) {
  return mem::make<xx::Function1p<F, P>>(f, std::forward<P>(p));
}
 ...
 */
template <typename T> inline Closure *new_closure(void (T::*f)(), T *o) {
  return mem::make<xx::Method0<T>>(f, o);
}
...
inline Closure *new_closure(F &&f, T *o, P &&p) {
  return mem::make<xx::Method1<F, T, P>>(std::forward<F>(f), o,
                                         std::forward<P>(p));
}
