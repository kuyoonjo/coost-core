...
public:
  ...
  fastream(fastream &&fs) noexcept : fast::stream(std::move(fs)) {}
  ...
  fastream &append(char c, size_t n) { return this->append(n, c); }

  fastream &append(const char *s) { return this->append(s, strlen(s)); }
  ...
  fastream &append(char c) { return (fastream &)fast::stream::append(c); }

  fastream &append(signed char c) { return this->append((char)c); }

  fastream &append(unsigned char c) { return this->append((char)c); }

  // append binary data of integer types
  fastream &append(uint16_t v) { return this->append(&v, sizeof(v)); }

  fastream &append(uint32_t v) { return this->append(&v, sizeof(v)); }

  fastream &append(uint64_t v) { return this->append(&v, sizeof(v)); }
  ...
  template <typename X, typename... V> fastream &cat(X &&x, V &&...v) {
  ...
  fastream &operator<<(const char *s) { return this->append(s, strlen(s)); }
  ...
  fastream &operator<<(const fastream &s) { return this->append(s); }
};
